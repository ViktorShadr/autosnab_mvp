...
- Full suite: 268 passed, same 12 known pre-existing failures (10 `test_receiving.py`, 2 `test_document_extraction_service.py`) unchanged, zero regressions. Not committed or deployed yet — awaiting go-ahead.
