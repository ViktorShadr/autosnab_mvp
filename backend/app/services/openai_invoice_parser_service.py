...
расхождений итогов и неуверенных границ таблицы. В document.document_confidence
указывай свою уверенность (0-1) отдельно для document_date, document_number,
supplier_name и total_with_vat — только для тех из них, которые ты фактически
заполнил; для пустого поля confidence не указывай.
